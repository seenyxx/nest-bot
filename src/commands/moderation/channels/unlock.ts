...
export default createSubCommand(
  {
    ...
    category: 'moderation',
    cooldown: 20,
    desc: 'Makes the channel mentioned or the current channel available to everyone.',
  ...
  async (msg, args) => {
    ...
    msg.reply(new Success('Unlocked Channel', 'Everyone is now allowed to send messages.'))
  }
)
